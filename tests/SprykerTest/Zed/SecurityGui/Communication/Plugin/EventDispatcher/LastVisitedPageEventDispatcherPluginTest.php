...
namespace SprykerTest\Zed\SecurityGui\Communication\Plugin\EventDispatcher;
...
class LastVisitedPageEventDispatcherPluginTest extends Unit
{
    ...
    public function testGivenLoggedInUserAndEligibleRequestWhenResponseDispatchedThenCookieIsSet(): void
    {
        // Arrange
    ...
    public function testGivenUserNotLoggedInWhenResponseDispatchedThenCookieIsNotSet(): void
    {
        // Arrange
    ...
    protected function createPlugin(bool $isEligible): LastVisitedPageEventDispatcherPlugin
    {
        ...
        $factoryMock = $this->getMockBuilder(SecurityGuiCommunicationFactory::class)
    ...
    {
        $event = new LogoutEvent(Request::create('/back-office/logout'), null);
